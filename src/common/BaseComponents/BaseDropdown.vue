...
.base-dropdown {
  &__trigger {
    @apply inline-flex justify-center w-full rounded-sm border border-gray-300 shadow-md px-4 py-2 bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal-900;
  }

  &__list {
    @apply origin-top-right absolute right-0 mt-2 w-56 rounded-sm shadow-md bg-white ring-1 ring-black ring-opacity-5 focus:outline-none;
  }
